...
bdRemovelowdata <- function(filename, group, dataset, outgroup, outdataset, pcent, SNPincols) {
    .Call('_BDSM_bdRemovelowdata', PACKAGE = 'BDSM', filename, group, dataset, outgroup, outdataset, pcent, SNPincols)
}
...
blockmult_hdf5 <- function(filename, group, A, B, block_size = NULL, paral = NULL, threads = NULL, mixblock_size = NULL, outgroup = NULL) {
    .Call('_BDSM_blockmult_hdf5', PACKAGE = 'BDSM', filename, group, A, B, block_size, paral, threads, mixblock_size, outgroup)
}
...
bdImputeSNPHDF5 <- function(filename, group, dataset, outgroup = NULL, outdataset = NULL, bycols = TRUE) {
    .Call('_BDSM_bdImputeSNPHDF5', PACKAGE = 'BDSM', filename, group, dataset, outgroup, outdataset, bycols)
}
...
Normalize_hdf5 <- function(filename, group, dataset, bcenter = NULL, bscale = NULL, wsize = NULL) {
    .Call('_BDSM_Normalize_hdf5', PACKAGE = 'BDSM', filename, group, dataset, bcenter, bscale, wsize)
}
...
Normalize_Data <- function(x, bcenter = NULL, bscale = NULL) {
    .Call('_BDSM_Normalize_Data', PACKAGE = 'BDSM', x, bcenter, bscale)
}
...
bdwXw <- function(X, W, op) {
    .Call('_BDSM_bdwXw', PACKAGE = 'BDSM', X, W, op)
}
...
bdMLR_MR <- function(X, y, blocks, threads = NULL) {
    .Call('_BDSM_bdMLR_MR', PACKAGE = 'BDSM', X, y, blocks, threads)
}
...
bdcrossprod <- function(a, transposed = NULL) {
    .Call('_BDSM_bdcrossprod', PACKAGE = 'BDSM', a, transposed)
}
...
bdwproduct <- function(a, w, op) {
    .Call('_BDSM_bdwproduct', PACKAGE = 'BDSM', a, w, op)
}
...
bdScalarwproduct <- function(a, w, op) {
    .Call('_BDSM_bdScalarwproduct', PACKAGE = 'BDSM', a, w, op)
}
...
blockmult <- function(a, b, block_size = NULL, paral = NULL, threads = NULL, bigmatrix = NULL, mixblock_size = NULL, outfile = NULL, onmemory = NULL) {
    .Call('_BDSM_blockmult', PACKAGE = 'BDSM', a, b, block_size, paral, threads, bigmatrix, mixblock_size, outfile, onmemory)
}

CholFactor <- function(a) {
    .Call('_BDSM_CholFactor', PACKAGE = 'BDSM', a)
}

CholSolve <- function(a, b) {
    .Call('_BDSM_CholSolve', PACKAGE = 'BDSM', a, b)
}

inversechol_par <- function(a, threads = NULL) {
    .Call('_BDSM_inversechol_par', PACKAGE = 'BDSM', a, threads)
}

partCrossProd <- function(X) {
    .Call('_BDSM_partCrossProd', PACKAGE = 'BDSM', X)
}

partCrossProd_block <- function(X) {
    .Call('_BDSM_partCrossProd_block', PACKAGE = 'BDSM', X)
}

parCrossProd <- function(X) {
    .Call('_BDSM_parCrossProd', PACKAGE = 'BDSM', X)
}

parCrossProd_block <- function(X) {
    .Call('_BDSM_parCrossProd_block', PACKAGE = 'BDSM', X)
}

partCrossProdEigen <- function(X) {
    .Call('_BDSM_partCrossProdEigen', PACKAGE = 'BDSM', X)
}
...
parXYProd <- function(X, Y, op = NULL) {
    .Call('_BDSM_parXYProd', PACKAGE = 'BDSM', X, Y, op)
}
...
parXYProdBlock <- function(X, Y, op = NULL) {
    .Call('_BDSM_parXYProdBlock', PACKAGE = 'BDSM', X, Y, op)
}

parxwxt <- function(X, W) {
    .Call('_BDSM_parxwxt', PACKAGE = 'BDSM', X, W)
}

parxtwx <- function(X, W) {
    .Call('_BDSM_parxtwx', PACKAGE = 'BDSM', X, W)
}

parXy <- function(X, Y) {
    .Call('_BDSM_parXy', PACKAGE = 'BDSM', X, Y)
}

JacobianSVD <- function(X) {
    .Call('_BDSM_JacobianSVD', PACKAGE = 'BDSM', X)
}

bdtsvd <- function(X, k = NULL) {
    .Call('_BDSM_bdtsvd', PACKAGE = 'BDSM', X, k)
}

bdsvd <- function(X) {
    .Call('_BDSM_bdsvd', PACKAGE = 'BDSM', X)
}
...
bdpseudoinv <- function(X) {
    .Call('_BDSM_bdpseudoinv', PACKAGE = 'BDSM', X)
}
...
bdQR <- function(X, thin = NULL) {
    .Call('_BDSM_bdQR', PACKAGE = 'BDSM', X, thin)
}

review_decomposition <- function(R, n) {
    .Call('_BDSM_review_decomposition', PACKAGE = 'BDSM', R, n)
}
...
bddtrsm <- function(R, Z, threads = NULL) {
    .Call('_BDSM_bddtrsm', PACKAGE = 'BDSM', R, Z, threads)
}
...
Create_HDF5_matrix_file <- function(filename, mat, group = NULL, dataset = NULL, transp = NULL) {
    .Call('_BDSM_Create_HDF5_matrix_file', PACKAGE = 'BDSM', filename, mat, group, dataset, transp)
}
...
Create_HDF5_matrix <- function(mat, filename, group, dataset, transp = NULL) {
    .Call('_BDSM_Create_HDF5_matrix', PACKAGE = 'BDSM', mat, filename, group, dataset, transp)
}
...
Remove_HDF5_element <- function(filename, element) {
    .Call('_BDSM_Remove_HDF5_element', PACKAGE = 'BDSM', filename, element)
}
...
bdInvCholesky <- function(x) {
    .Call('_BDSM_bdInvCholesky', PACKAGE = 'BDSM', x)
}
...
bdSVD <- function(x, k = 0L, nev = 0L, bcenter = TRUE, bscale = TRUE) {
    .Call('_BDSM_bdSVD', PACKAGE = 'BDSM', x, k, nev, bcenter, bscale)
}
...
bdSVD_hdf5 <- function(x, group = NULL, dataset = NULL, k = 2L, q = 1L, bcenter = TRUE, bscale = TRUE, threads = NULL) {
    .Call('_BDSM_bdSVD_hdf5', PACKAGE = 'BDSM', x, group, dataset, k, q, bcenter, bscale, threads)
}
...
bdSVD_lapack <- function(x, bcenter = TRUE, bscale = TRUE) {
    .Call('_BDSM_bdSVD_lapack', PACKAGE = 'BDSM', x, bcenter, bscale)
}
